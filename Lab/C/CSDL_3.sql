...
--3.1
SELECT HOSV,TENSV,NOISINH,NGAYSINH FROM DMSV WHERE MONTH(NGAYSINH)=2 AND NOISINH LIKE N'HÀ NỘI'

--3.2
SELECT HOSV,TENSV,NOISINH, DATEDIFF(YEAR,NGAYSINH,GETDATE()) AS TUOI FROM DMSV WHERE DATEDIFF(YEAR,NGAYSINH,GETDATE())>20
--3.3
SELECT HOSV,TENSV,DATEDIFF(YEAR,NGAYSINH,GETDATE()) AS TUOI
FROM DMSV WHERE DATEDIFF(YEAR,NGAYSINH,GETDATE()) BETWEEN 20 AND 25
--3.4
SELECT HOSV,TENSV,PHAI,NGAYSINH
FROM DMSV WHERE DATEPART(MONTH,NGAYSINH) BETWEEN 3 AND 5 AND DATEPART(YEAR,NGAYSINH)=1990
--3.5
...
--3.6
SELECT HOSV,TENSV,MAMH,LANTHI,DIEM,KETQUA=
  CASE
