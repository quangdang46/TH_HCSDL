...
-- SELECT * FROM DMMH
--4.3
UPDATE DMSV SET TENSV=N'KỲ' WHERE HOSV=N'TRẦN THANH' AND TENSV=N'MAI'
-- SELECT * FROM DMSV
--4.4
UPDATE DMSV SET PHAI=0 WHERE HOSV=N'TRẦN THANH' AND TENSV=N'KỲ'
-- SELECT * FROM DMSV
--4.5
UPDATE DMSV SET NGAYSINH='05/07/1990' WHERE HOSV=N'TRẦN THỊ THU' AND TENSV=N'THUỶ'
-- SELECT * FROM DMSV
--4.6
UPDATE DMSV SET HOCBONG+=100000 WHERE MAKHOA='AV'
-- SELECT * FROM DMSV
--4.7
